...
export const slides = [
    ...
    <div class="row content-row" key="s2">
        ...
        using the name `row`).
            ...
            <p>
                <img
                    src="images/northwind/product-category-supplier.png"
            ...
            <p>
                ...
                <a href="/#" class="badge badge-light"><span class="fa fa-play-circle-o fa-lg pr-2" aria-hidden="true"></span>LOAD CSV</a>
            </p>
        </div>
        <div className="col-sm-9">
            <h4>Load records</h4>
...
SET n = row`}
    ...
    <div class="row content-row" key="s3">
        <div className="col-sm-3">
            ...
            <p>
                <img
                    src="images/northwind/product-graph.png"
                    className="img-responsive"
                />
            </p>
            <hr />
...
CREATE (s)-[:SUPPLIES]->(p)`}
    ...
    <div class="row content-row" key="s4">
        <div className="col-sm-3">
...
RETURN DISTINCT s.companyName as ProduceSuppliers`}
    ...
    <div class="row content-row" key="s5">
        <div className="col-sm-3">
            <h3>Customer Orders</h3>
            <p>
                Northwind customers place orders which may detail multiple products.
        <img
                    src="images/northwind/customer-orders.png"
                    className="img-responsive"
                />
            </p>
            <hr />
    ...
    <div class="row content-row" key="s6">
        ...
        between two other records.
            ...
            <p>
                ...
                in the graph.
        <img
                    src="images/northwind/order-graph.png"
                    className="img-responsive"
                />
            </p>
            <hr />
