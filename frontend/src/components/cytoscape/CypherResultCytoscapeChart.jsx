...
class CytoscapeComponent extends Component {
    ...
    captionChange(elementType, label, caption) {
        if (caption === 'gid') {
            this.cy.elements(elementType + '[label = "' + label + '"]').style('label', function (ele) {
                return ele == null ? '' : "[ " + ele.data('id') + " ]";
            })
        } else if (caption === 'label') {
            this.cy.elements(elementType + '[label = "' + label + '"]').style('label', function (ele) {
                return ele == null ? '' : "[ :" + ele.data('label') + " ]";
            })
        } else {
            this.cy.elements(elementType + '[label = "' + label + '"]').style('label', function (ele) {
                return ele == null ? '' : (ele.data('properties')[caption] == null ? '' : ele.data('properties')[caption])
            })
        }
    }
